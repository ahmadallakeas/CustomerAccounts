using AccountsService.API.Consumers;
...
namespace UsersService.API
{
    ...
    {
        public static void AddAccountsServiceServices(this IServiceCollection services, IConfiguration configuration)
        {
        ...
        {
            services.Configure<JwtConfiguration>(configuration.GetSection("AccountsSettings"));
        }
        ...
        {
            services.Configure<MongoDbConfiguration>(configuration.GetSection("AccountsDatabase"));
        ...
        public static void ConfigureMassTransit(IServiceCollection services)
        {
            ...
            {
                mt.AddConsumer<CustomerCreatedConsumer>();
                mt.UsingRabbitMq((context, config) =>
                {
                    ...
                    config.ReceiveEndpoint("created-customer", e =>
                    {
                        e.ConfigureConsumer<CustomerCreatedConsumer>(context);
                    });
                    config.Publish<TotalChanged>();
                });
            });
